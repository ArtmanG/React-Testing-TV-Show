...
[x] where the async call is, (in useEffect in App.js)

[x] and where different data pieces are being rendered.  (my best guess is in the returns in App.js and Episode.js)
